...
(function ($) {
	Drupal.behaviors.home_page = {
		attach: function (context, settings) {
		  ...
		  $(document).ready(function() {
			  if ($(window).width() > 983) {
			  	var manu = '<li id="more-submenu"><a id="more-link">More</a><ul id="more-list"><li><a href="/book-session">Book a Free Session</a></li><li><a href="/social-selling-case-studies">Social Selling Case Studies</a></li></ul></li>';
